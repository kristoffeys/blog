...
const Header = ({ siteTitle }) => (
  <header className="border-t-[6px] border-t-primary border-b border-b-gray-300">
    <nav className="font-sans flex items-center justify-between flex-wrap p-6 max-w-container mx-auto">
      <div className="flex items-center flex-shrink-0 mr-6">
        <h1>
          <Link to="/" className="font-semibold text-xl tracking-wide text-black uppercase">
      ...
      <div className="block lg:hidden">
        <button className="flex items-center px-3 py-2 border rounded text-gray-400 border-gray-400 hover:text-black hover:border-black">
      ...
      <div className="w-full block flex-grow lg:flex lg:items-center lg:w-auto">
        <ul className="text-sm lg:flex-grow text-right">
          <li>
            <Link to="/" className="block mt-4 lg:inline-block lg:mt-0 mr-4 text-black">About</Link>
            <Link to="/blog" className="block mt-4 lg:inline-block lg:mt-0 mr-4 text-black">Blog</Link>
          </li>
        </ul>
      </div>
    </nav>
